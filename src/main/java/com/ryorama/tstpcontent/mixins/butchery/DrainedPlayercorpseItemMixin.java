...
@Mixin(DrainedplayercorpseitemItem.class)
public abstract class DrainedPlayercorpseItemMixin extends Item implements IPlayerCorpse {
    @Unique
    public UUID playerUUID = new UUID(0L, 0L);

    public DrainedPlayercorpseItemMixin(Properties properties) {
        super(properties);
    }
