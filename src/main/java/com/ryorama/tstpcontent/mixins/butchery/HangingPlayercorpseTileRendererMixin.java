...
@Mixin(HangingplayercorpseTileRenderer.class)
public abstract class HangingPlayercorpseTileRendererMixin extends GeoBlockRenderer<PlayercorpseTileEntity> {
    public HangingPlayercorpseTileRendererMixin(GeoModel<PlayercorpseTileEntity> model) {
        super(model);
    }
