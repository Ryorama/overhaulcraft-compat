...
import net.mcreator.butcher.block.renderer.DrainedplayercorpseTileRenderer;
import net.mcreator.butcher.block.renderer.HangingdrainedplayercorpseTileRenderer;
import net.minecraft.resources.ResourceLocation;
import org.spongepowered.asm.mixin.Mixin;
import software.bernie.geckolib.model.GeoModel;
import software.bernie.geckolib.renderer.GeoBlockRenderer;

@Mixin(HangingdrainedplayercorpseTileRenderer.class)
public abstract class HangingDrainedPlayercorpseTileRendererMixin extends GeoBlockRenderer<PlayercorpseTileEntity> {
    public HangingDrainedPlayercorpseTileRendererMixin(GeoModel<PlayercorpseTileEntity> model) {
        super(model);
    }
