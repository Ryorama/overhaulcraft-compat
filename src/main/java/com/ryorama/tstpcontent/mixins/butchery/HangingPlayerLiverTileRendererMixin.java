...
@Mixin(HangingplayerliverTileRenderer.class)
public abstract class HangingPlayerLiverTileRendererMixin extends GeoBlockRenderer<PlayercorpseTileEntity> {
    public HangingPlayerLiverTileRendererMixin(GeoModel<PlayercorpseTileEntity> model) {
        super(model);
    }
