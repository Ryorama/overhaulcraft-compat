...
@Mixin(HangingplayerarmlessTileRenderer.class)
public abstract class HangingPlayerArmlessTileRendererMixin extends GeoBlockRenderer<PlayercorpseTileEntity> {
    public HangingPlayerArmlessTileRendererMixin(GeoModel<PlayercorpseTileEntity> model) {
        super(model);
    }
