...
import net.mcreator.butcher.block.renderer.HangingplayerheartTileRenderer;
import net.mcreator.butcher.block.renderer.HangingplayerintestinesTileRenderer;
import net.minecraft.resources.ResourceLocation;
import org.spongepowered.asm.mixin.Mixin;
import software.bernie.geckolib.model.GeoModel;
import software.bernie.geckolib.renderer.GeoBlockRenderer;

@Mixin(HangingplayerintestinesTileRenderer.class)
public abstract class HangingPlayerIntestinesTileRendererMixin extends GeoBlockRenderer<PlayercorpseTileEntity> {
    public HangingPlayerIntestinesTileRendererMixin(GeoModel<PlayercorpseTileEntity> model) {
        super(model);
    }
