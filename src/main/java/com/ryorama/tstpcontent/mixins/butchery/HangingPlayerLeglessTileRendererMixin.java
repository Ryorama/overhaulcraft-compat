...
import net.mcreator.butcher.block.renderer.HangingplayerleglessTileRenderer;
import net.minecraft.resources.ResourceLocation;
import org.spongepowered.asm.mixin.Mixin;
import software.bernie.geckolib.model.GeoModel;
import software.bernie.geckolib.renderer.GeoBlockRenderer;

@Mixin(HangingplayerleglessTileRenderer.class)
public abstract class HangingPlayerLeglessTileRendererMixin extends GeoBlockRenderer<PlayercorpseTileEntity> {
    public HangingPlayerLeglessTileRendererMixin(GeoModel<PlayercorpseTileEntity> model) {
        super(model);
    }
