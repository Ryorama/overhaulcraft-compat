...
import net.mcreator.butcher.block.renderer.HangingplayerleftlegTileRenderer;
import net.minecraft.resources.ResourceLocation;
import org.spongepowered.asm.mixin.Mixin;
import software.bernie.geckolib.model.GeoModel;
import software.bernie.geckolib.renderer.GeoBlockRenderer;

@Mixin(HangingplayerleftlegTileRenderer.class)
public abstract class HangingPlayerLeftLegTileRendererMixin extends GeoBlockRenderer<PlayercorpseTileEntity> {
    public HangingPlayerLeftLegTileRendererMixin(GeoModel<PlayercorpseTileEntity> model) {
        super(model);
    }
