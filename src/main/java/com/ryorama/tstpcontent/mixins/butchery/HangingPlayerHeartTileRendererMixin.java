...
@Mixin(HangingplayerheartTileRenderer.class)
public abstract class HangingPlayerHeartTileRendererMixin extends GeoBlockRenderer<PlayercorpseTileEntity> {
    public HangingPlayerHeartTileRendererMixin(GeoModel<PlayercorpseTileEntity> model) {
        super(model);
    }
