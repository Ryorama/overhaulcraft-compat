...
@Mixin(DrainedplayercorpseTileRenderer.class)
public abstract class DrainedPlayercorpseTileRendererMixin extends GeoBlockRenderer<PlayercorpseTileEntity> {
    public DrainedPlayercorpseTileRendererMixin(GeoModel<PlayercorpseTileEntity> model) {
        super(model);
    }
