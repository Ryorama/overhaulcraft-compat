package com.ryorama.tstpcontent.world.features;

import com.mojang.serialization.Codec;
import com.ryorama.tstpcontent.utils.MathHelper;
...
public abstract class TstpFeature extends Feature<NoneFeatureConfiguration> {
    public TstpFeature() {
    ...
    public boolean placeOre2(WorldGenLevel worldIn, RandomSource rand, BlockPos pos, int size, BlockState target, BlockState state) {
