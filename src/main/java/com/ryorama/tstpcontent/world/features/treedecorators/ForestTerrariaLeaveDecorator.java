...
public class ForestTerrariaLeaveDecorator extends LeaveVineDecorator {
	public static Codec<LeaveVineDecorator> CODEC = Codec.unit(ForestTerrariaLeaveDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(ForgeRegistries.Keys.TREE_DECORATOR_TYPES, registerHelper -> registerHelper.register("forest_terraria_tree_leave_decorator", DECORATOR_TYPE));
	}

	public ForestTerrariaLeaveDecorator() {
		super(0.25f);
	}
