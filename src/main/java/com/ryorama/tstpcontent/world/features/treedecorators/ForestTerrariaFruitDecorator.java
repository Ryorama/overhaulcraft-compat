...
package com.ryorama.tstpcontent.world.features.treedecorators;
...
public class ForestTerrariaFruitDecorator extends CocoaDecorator {
	public static Codec<ForestTerrariaFruitDecorator> CODEC = Codec.unit(ForestTerrariaFruitDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(ForgeRegistries.Keys.TREE_DECORATOR_TYPES, registerHelper -> registerHelper.register("forest_terraria_tree_fruit_decorator", DECORATOR_TYPE));
	}

	public ForestTerrariaFruitDecorator() {
		super(0.2f);
	}
