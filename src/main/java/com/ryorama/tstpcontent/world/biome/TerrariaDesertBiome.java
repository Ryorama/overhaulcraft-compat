...
package com.ryorama.tstpcontent.world.biome;
...
public class TerrariaDesertBiome {
	public static Biome createBiome() {
		...
		biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION,
				PlacementUtils.register("tstp_content:tree_terraria_desert",
						FeatureUtils.register("tstp_content:tree_terraria_desert", Feature.TREE,
								new TreeConfiguration.TreeConfigurationBuilder(BlockStateProvider.simple(TstpContentModBlocks.CACTUS.get().defaultBlockState()), new StraightTrunkPlacer(7, 2, 0),
