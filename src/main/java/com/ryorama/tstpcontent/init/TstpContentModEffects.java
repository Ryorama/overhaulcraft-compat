...
public class TstpContentModEffects {
    ...
    public static RegistryObject<MobEffect> RANDOMIUMSIGHT = REGISTRY.register("randomium_ore_sight_effect", () -> new OreSightEffect(MobEffectCategory.BENEFICIAL, OresRef.RANDOMIUM.toString(), 9766589));
}
