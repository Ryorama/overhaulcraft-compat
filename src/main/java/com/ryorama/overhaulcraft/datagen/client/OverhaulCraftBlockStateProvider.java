...
public class OverhaulCraftBlockStateProvider extends BlockStateProvider {
    public OverhaulCraftBlockStateProvider(DataGenerator generator, ExistingFileHelper fileHelper) {
    ...
    protected void registerStatesAndModels() {
        OverhaulCraftOreBlocks.BLOCK_REGISTRY.getEntries().forEach(blockDeferredHolder -> {
            ...
            if (id.contains("cake")) {
                ...
                simpleBlockWithItem(blockDeferredHolder.get(), models().cubeAll(id, ResourceLocation.fromNamespaceAndPath(OverhaulCraft.MODID, "block/ores/" + id)));
            }
        });
    }
}