...
public class OverhaulCraftTabs {
	...
	public static final RegistrySupplier<CreativeModeTab> TSTP_GT = REGISTRY.register("tstp_gt",
			() -> CreativeModeTab.builder().title(Component.translatable("item_group.tstp_content.tstp_gt")).icon(() -> new ItemStack(OverhaulCraftBlocks.CALORITE_MACHINE_CASING.get())).displayItems((parameters, tabData) -> {
				tabData.accept(OverhaulCraftBlocks.CALORITE_MACHINE_CASING.get().asItem());
				tabData.accept(OverhaulCraftBlocks.OSTRUM_MACHINE_CASING.get().asItem());
			}).build());
	//public static final RegistrySupplier<CreativeModeTab> TSTP_TAS = REGISTRY.register("tstp_tas",
			...
			//}).build());
	//public static final RegistrySupplier<CreativeModeTab> TSTP_MRCF = REGISTRY.register("tstp_mrcf",
